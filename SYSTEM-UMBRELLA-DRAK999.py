...
print ('''{yellow}
┌─────────────────────────────────────────────────────────────────────────┐	 
|                 | VIIP    |DDOS LAYER 7 |   VIIP|                       |
└─────────────────────────────────────────────────────────────────────────┘
           ||                                         ||
┌─────────────────────────────────────────────────────────────────────────┐
|[VIIP]|     [+] DDOS ON METEOR API C2                                    | 
|[VIIP]|     [+] DDOS ON LAYER 7 API C9999                                |
|[VIIP]|     [+] DDOS ON LAYER 999 API C999999999                         |
|[SUPPROT]|  [+] SYSTEM UMBRELLA DRAK999                                  |
|[TIKTOK]|   [+] SPOKYHOZOO02                                             |
└─────────────────────────────────────────────────────────────────────────┘
''')
...
if __name__ == "__main__":
	main()#Coded by SYSTEM UMBRELLA DRAK999
